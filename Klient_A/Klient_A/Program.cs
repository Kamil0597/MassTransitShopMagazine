...
namespace Klient_B
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ConsoleCol.WriteLine("Jestem: Klientem A", ConsoleColor.Cyan);
            ...
            var bus = Bus.Factory.CreateUsingRabbitMq(cfg =>
            {
                ...
                cfg.ReceiveEndpoint("client_a_queue", e =>
                {
            ...
            while (true)
            {
                ...
                bus.Publish(new StartZamowienia { OrderId = orderID, Ilosc = liczba, QueueName = "client_a_queue" });
